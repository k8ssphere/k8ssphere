...
import (
	...
	"k8ssphere.io/k8ssphere/pkg/client/clientset/versioned/scheme"
)
...
// OrderV1alpha1Client is used to interact with features provided by the order group.
type OrderV1alpha1Client struct {
	restClient rest.Interface
}

func (c *OrderV1alpha1Client) Cates(namespace string) CateInterface {
	return newCates(c, namespace)
}
